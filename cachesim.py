...
cachesize = sys.argv[2] #cachesize in kB
blocksize = int(sys.argv[3], 10)	#blocksize in B
cachesize = int(cachesize, 10) * 1024
associativity = int(sys.argv[4],10)
...
indexbits = math.log(cachesize/(blocksize * associativity), 2)
...
#	loops through file
#	reads each line, obtains the instuction type, it's index and it's tag
#	counts occurences of each instruction type and compares the tag
#	to what is in the cache, counting the inconsistencies (errors)
